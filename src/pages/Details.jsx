      ...
      <section id="best">
        <div className="head">
          <div>
            ...
            <h2 className="w-[362px] max-tab-min:w-full">The Best<span className="text-praim6"> Projects</span></h2>
          </div>
          <div className="flex-bet-center gap-2 *:size-9 *:text-center *:border-[1px] *:border-praim6 *:rounded-full max-mob:mt-3" >
